...
For help setting up and configuring Liana Automation, please refer to [LianaAutomation introduction](https://support.lianatech.com/hc/en-us/categories/4409287060881-LianaAutomation).

= Where can I get help or talk to other users about Liana Automation? =

If you get stuck, you can ask for help.

= Will LianaAutomation WooCommerce work with my theme? =

Yes, this plugin should work with any theme.
...
* **Change:** Deprecated marketing permission field. Field key is automatically appended to user meta keys.
...
= 1.1.2 2024-12-20 =
* **Change:** User meta data is now also sent with customer created/edited hooks in Customer event
